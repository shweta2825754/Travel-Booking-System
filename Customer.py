...
label_0 = Label(root, text="Booking",width=20,font=("bold", 20))
...
label_7 = Label(root, text="FlightName",width=20,font=("bold", 10))
label_7.place(x=80,y=260)

entry_7 = Entry(root,textvar=Flight)
entry_7.place(x=240,y=260)

label_4 = Label(root, text="payment",width=20,font=("bold", 10))
label_4.place(x=85,y=330)
var2= IntVar()
Checkbutton(root, text="Credit", variable=var1).place(x=235,y=330)

Checkbutton(root, text="Net", variable=var2).place(x=290,y=330)
